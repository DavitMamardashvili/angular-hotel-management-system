...
export class HomeComponent implements OnInit{
  ...
  constructor(private http: HttpClient, private filterService: FilterService, private router: Router, private activatedRoute: ActivatedRoute) { }

  ngOnInit(): void {
    this.fetchHotels();
    const delayObservable = of(null).pipe(delay(300));
  ...
  fetchHotels() {
    this.http.get('http://www.airbnb-digital-students.somee.com/api/Apartments/filter')
